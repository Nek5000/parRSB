...
int flex_cg(genmap_handle h, genmap_comm c, mgData d, GenmapVector r,
            int maxIter, GenmapVector x);

int project(genmap_handle h, genmap_comm c, mgData d, GenmapVector r,
            int maxIter, GenmapVector x);
int project_lvl(genmap_handle h, genmap_comm c, mgData d, GenmapScalar *ri,
                int maxIter, int lvl_start, GenmapScalar *xo);

int rqi(genmap_handle h, genmap_comm c, mgData d, GenmapVector z, int maxIter,
        GenmapVector fiedler);
int fmg(genmap_handle h, genmap_comm c, mgData d, GenmapScalar *z, int maxIter,
