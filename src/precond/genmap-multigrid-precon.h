...
int rqi(genmap_handle h, GenmapComm c, mgData d, GenmapVector z, int maxIter,
        int verbose, GenmapVector fiedler);
int fmg(genmap_handle h, GenmapComm c, mgData d, GenmapScalar *z, int maxIter,
        int verbose, GenmapScalar *fiedler);
